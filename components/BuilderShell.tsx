...
export default function BuilderShell({
  ...
  return (
    <div className="h-screen flex flex-col" style={{ fontFamily: 'var(--font-dm-sans)' }}>
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-[minmax(0,65fr)_minmax(360px,35fr)]">
        <div className="min-w-0 min-h-0">{previewPanel}</div>

        <div className="min-w-0 min-h-0 lg:min-w-[360px] lg:max-w-[480px] h-full flex flex-col bg-white border-t lg:border-t-0 lg:border-l border-gray-100">
