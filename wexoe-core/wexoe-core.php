 ...
 * Description: Unified Airtable data layer for Wexoe's WordPress plugins. Phase 5: retries, schema health check, stale cache strategy.
 * Version:     0.6.0
...
define('WEXOE_CORE_VERSION', '0.6.0');
