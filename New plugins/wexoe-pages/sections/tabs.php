...
body #top #<?= esc_attr($wid) ?> .wxp-section--on-dark .wxp-tabs__pill { border-color: #fff !important; color: #11325D !important; background: #fff !important; background-color: #fff !important; }
...
body #top #<?= esc_attr($wid) ?> .wxp-section--on-dark .wxp-tabs__pill:hover:not(.is-active) { background: #fff !important; background-color: #fff !important; color: #11325D !important; border-color: #fff !important; }
