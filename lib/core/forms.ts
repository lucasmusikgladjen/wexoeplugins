...
export const CORE_ENTITY_FORMS: Record<CoreEntityName, CoreEntityFormConfig> = {
  core_company: {
    listLabelField: 'slug',
    listMetaField: 'company_name',
    fields: [
      { key: 'slug', label: 'Slug', type: 'text', isPrimary: true, help: 'Stabil ID, t.ex. wexoe-se. Lower-kebab.' },
      { key: 'is_default', label: 'Är default', type: 'checkbox', help: 'Sätt på exakt ett record. Fallback när inget land-kontext finns.' },
      ...
      { key: 'hours_mon_fri', label: 'Öppettider mån-fre', type: 'text', width: 'half' },
      { key: 'hours_saturday', label: 'Öppettider lördag', type: 'text', width: 'half' },
      { key: 'hours_sunday', label: 'Öppettider söndag', type: 'text', width: 'half' },
      { key: 'hours_lunch', label: 'Lunchstängning', type: 'text', width: 'half' },
      { key: 'hours_override', label: 'Speciella öppettider', type: 'textarea', help: 'En rad per period, t.ex. "24/12: Stängt".' },
